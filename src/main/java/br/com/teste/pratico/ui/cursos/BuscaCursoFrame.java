...
public class BuscaCursoFrame extends JFrame {
	...
	public BuscaCursoFrame(CursosFrame framePrincipal) {
	...
	private class BuscarPorNomeListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				final List<Curso> alunos = dao.getAlunosByNome(tfNome.getText());
				resetForm();
				setVisible(false);
				
				//framePrincipal.refreshTable(alunos);
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(BuscaCursoFrame.this,
