package br.com.teste.pratico.util;
...
public class ApplicationProperties {
	...
	static {
		try {
			...
			while (resources.hasMoreElements()) {
		    	...
		    	if (manifest.getMainAttributes().getValue("Built-By") != null && manifest.getMainAttributes().getValue("Built-By").equals("teste-pratico")){
	...
	public static URL getURLLogo() { 
        URL imageURL = ApplicationProperties.class.getClassLoader().getResource("#");
        return imageURL;  
    }
}
